                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody class="adding_td adding_th">
                                            ...
                                            <select id="category" name="category" required class="form-control">
                                                ...
                                                <?php if(!empty($categorys)): ?>
                                                    <?php foreach($categorys as $value): ?>
                                                        <option value="<?=$value->name?>" <?php if($cid==$value->name) echo 'selected'; ?>>
                                                            <?=$value->name?></option>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                            </select>
                            ...
                            <tr>
                                <th>상품 명(영문)</th>
                                <td>
                                     <input type="text" class="required" id="eg_name" 
                                     name="eg_name" maxlength="128" value="<?=$eg_name?>" required>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    name="orgprice" maxlength="10"  value="<?=$orgprice?>" required >원</div>
                                    <div>
                                        *할인판매가 <input type="text" class="required" id="singo"  name="singo" maxlength="128" 
                                        value="<?=$singo?>" required>원 (싱글)
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="mid">
                                    ...
                                    <div class="line">
                                        *우선순위 <input type="text" id="p_idx"  name="p_idx"  value="<?=$p_idx?>">
                                    </div>
                                    <div class="line">
                                        *판매량 <input type="text" id="p_salecnt"  name="p_salecnt"  value="<?=$p_salecnt?>">
                                    </div>
                                    <div class="line">
                                    ...
                                    <div class="line">
                                        *적립포인트 <input type="text" class="required" id="point"  name="point" maxlength="128" value="<?=$point?>" required>
                                        <div class="guide_text">
                                            <span class="ic_blue"></span>
