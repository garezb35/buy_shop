<?php 
  ...
  $amount1 = 0;
  // if($OrderHistory1[0]->A !=null) $amount1 = $amount1 + $OrderHistory1[0]->A;
  // if($OrderHistory1[0]->B !=null) $amount1 = $amount1 + $OrderHistory1[0]->B;
  // if($OrderHistory1[0]->C !=null) $amount1 = $amount1 + $OrderHistory1[0]->C;
  // if($OrderHistory1[0]->D !=null) $amount1 = $amount1 + $OrderHistory1[0]->D;

  // $amount2 = 0;
  // if($OrderHistory2[0]->A !=null) $amount2 = $amount2 + $OrderHistory2[0]->A;
  // if($OrderHistory2[0]->B !=null) $amount2 = $amount2 + $OrderHistory2[0]->B;
  // if($OrderHistory2[0]->C !=null) $amount2 = $amount2 + $OrderHistory2[0]->C;
  // if($OrderHistory2[0]->D !=null) $amount2 = $amount2 + $OrderHistory2[0]->D;

  // $amount3 = 0;
  // if($OrderHistory3[0]->A !=null) $amount3 = $amount3 + $OrderHistory3[0]->A;
  // if($OrderHistory3[0]->B !=null) $amount3 = $amount3 + $OrderHistory3[0]->B;
  // if($OrderHistory3[0]->C !=null) $amount3 = $amount3 + $OrderHistory3[0]->C;
  // if($OrderHistory3[0]->D !=null) $amount3 = $amount3 + $OrderHistory3[0]->D;

  // $amount4 = 0;
  // if($OrderHistory4[0]->A !=null) $amount4 = $amount4 + $OrderHistory4[0]->A;
  // if($OrderHistory4[0]->B !=null) $amount4 = $amount4 + $OrderHistory4[0]->B;
  // if($OrderHistory4[0]->C !=null) $amount4 = $amount4 + $OrderHistory4[0]->C;
  // if($OrderHistory4[0]->D !=null) $amount4 = $amount4 + $OrderHistory4[0]->D;
                    ...
                    <?php if(!empty($payHistory)): ?>
                      <?php foreach($payHistory as $value): ?>
                        <tr>
                          ...
                          <td><?=$value->Pcount?><br><?=$value->PSum?></td>
                          ...
                          <?php if($value->sending_price > 0 && $value->dtype ==1): ?>
                            ...
                            <?=number_format($value->sending_price)?>원</a>
                          <?php endif; ?>
