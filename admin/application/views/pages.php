        ...
        <?php echo form_open_multipart('addPage');?>
          ...
          <div class="row my-3">
            ...
            <div class="col-md-8">
              ...
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="1" <?=$my==1 ? "checked":""?> name="my">
                <label class="form-check-label" for="inlineCheckbox1">마이페이지</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="1" <?=$footer==1 ? "checked":""?> name="footer">
                <label class="form-check-label" for="inlineCheckbox1">Footer</label>
              </div>
            </div>
          </div>
          <div class="row my-3">
          ...
          <div class="row my-3">
              <div class="col-md-12 text-center">
                  <a href="/admin/pages" class="btn btn-primary">새로 등록페지에로</a>
