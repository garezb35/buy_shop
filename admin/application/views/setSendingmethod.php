<?php 
    ...
    if(!empty($deli)): 
        ...
        foreach($deli as $value):
            ...
            $startPrice = $value->startPrice*$halin;
            while($start1<=$start2){    
                ...
                <div class="box-body table-responsive no-padding">
                    <table cellpadding="0" cellspacing="0" border="0" class="order_write" style="width: 100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>회원구매 수수료</th>
                                <td><input type="text" name="BUY_FEE_RT" id="BUY_FEE_RT" maxlength="10"  onblur="fnNumChiperCom(this, '0');fnBuyPrice();" class="input_txt2" value="<?=empty($pur_fee) ? 0 : $pur_fee?>"> %</td>
                                <th>현지 배송비  </th>
                                <td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    value="<?=!empty($delivery[0]->gwatae) ? $delivery[0]->gwatae :$custom_fee[0]->gate_fee?>">원
                                <th>부피무게</th>
                                <td>
                            ...
                            <tr>
                                ...
                                <th>추가결제금액</th>
                                <td>
                                    <input type="text" name="FIVE_MNY" id="FIVE_MNY" maxlength="10" style="width: 74%;" onblur="fnNumChiperCom(this, '0');" class="input_txt2" value="<?=$delivery[0]->add_price?>" readonly="">원
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
<script>
    ...
    <?php endforeach; ?>
    <?php endif; ?>
    <?php if($this->input->get("ORD_TY_CD") !=2 && $this->input->get("ORD_TY_CD") !=3): ?>
    fnDlvrPrice();
    <?php endif; ?>
    ...
    function fnActingfMny5(){
        ...
        $("#CHA_CD").val('5');
        $(frmObj).attr("action", "./ActiveMoney");
        $(frmObj).submit();
    }
</script>
</body>
