   ...
   <section class="content">
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <form method="post" name="frmPageInfo" id="frmPageInfo" action="./updateDeliver" enctype="multipart/form-data">
                  ...
                  <div id="stepOrd-EtcTt" style="">
                     ...
                     <div class="step_box">
                        ...
                        <div class="orderStepTit">
                           ...
                           <h4>
                              상품 정보를 입력해 주세요 <!--a href="/Front/Page/UserPage.asp?gMnu1=201&gMnu2=20116"  target="_blank" class="btn_m">[ 자세히 보기 ]</a-->
                           </h4>
                        </div>
                        <!-- B: 상품 상세 -->
   ...
   var main_array  =new Array(); 
      for( var i=1; i<=$("#sProNum").val(); i++ ) {
         ...
         if($("input[name='TRACKING_NO_YN']").eq(i-1).prop('checked')){
            ...
            temp_array.push($("select[name='FRG_DLVR_COM']").eq(i-1).val()==null || $("select[name='FRG_DLVR_COM']").eq(i-1).val()==""?"":$("select[name='FRG_DLVR_COM']").eq(i-1).val());
            temp_array.push($("input[name='FRG_IVC_NO']").eq(i-1).val()==null || $("input[name='FRG_IVC_NO']").eq(i-1).val()==""?"":$("input[name='FRG_IVC_NO']").eq(i-1).val());
         }
      ...
      $(gFrmNm).attr("action", "./UpdateDelivery").attr("target", "prcFrm");
      $(gFrmNm).submit();
   }
  ...
  $.ajax({
   ...
   contentType: false,
      ...
      success:function(data){             
          ...
          if(data.errorId==0){
            debugger;
            $("#TextProduct"+$("#product_val").val()+" #IMG_URL").val("/upload/delivery/"+data.img);
