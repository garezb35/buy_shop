	...
	<div class="container">
		<div class="row">
				...
				<table class="table table-dark">
				    ...
				    <tbody>
				    	...
				    	<tr style="border-bottom: 1px solid">
				    		...
				    		<td><a href="editDeliveryAddr/<?=$value->id?>" class="btn btn-warning btn-sm" style="margin-right: 5px">수정</a>
			...
			<div class="text-center">
				<a href="/registerDeliveryAddr" class="btn btn-warning  btn-sm">등록</a>
